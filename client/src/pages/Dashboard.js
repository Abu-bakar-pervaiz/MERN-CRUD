                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    <div className="support-ticket media pb-1 mb-3">
                      <img src="assets/img/users/user-1.png" className="user-img mr-2" alt="image" />
                    ...
                    <div className="support-ticket media pb-1 mb-3">
                      <img src="assets/img/users/user-2.png" className="user-img mr-2" alt="image" />
                      <div className="media-body ml-3">
                    ...
                    <div className="support-ticket media pb-1 mb-3">
                      <img src="assets/img/users/user-3.png" className="user-img mr-2" alt="image" />
                      <div className="media-body ml-3">
                    ...
                    <div className="support-ticket media pb-1 mb-3">
                      <img src="assets/img/users/user-6.png" className="user-img mr-2" alt="image" />
                      <div className="media-body ml-3">
                        ...
                        <p className="my-1">Hi, John, can you work on increase page speed of template...
                        </p>
